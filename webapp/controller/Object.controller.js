sap.ui.define([
    ...
    return BaseController.extend("sap.fiori.freestyle.controller.Object", {
                ...
                onClose: function (sAction) {
                    if (sAction === MessageBox.Action.OK) {
                        oModel.remove(oContext.getPath(), {
                            ...
                            error: function () {
                                sap.m.MessageToast.show("Error deleting product");
                            }
                        });
                    }
                }
         ...
         * @param {sap.ui.base.Event} oEvent the route pattern matched event
         * @private
         */
